...
public interface CustomDialogThreeButtonListener {
    ...
    // Called when the neural button of the dialog is being clicked
    void onDialogNeutralButtonClick(DialogInterface dialog, int which);
}
